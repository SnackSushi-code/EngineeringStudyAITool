...
_JOB_OBJECT_INFO_CLASS_EXTENDED_LIMIT = 9

_JOB_OBJECT_INFO_CLASS_CPU_RATE_CONTROL = 15
    ...
    def prepare(
        ...
        try:
            ...
            result = self._kernel32.SetInformationJobObject(
                ...
                _JOB_OBJECT_INFO_CLASS_EXTENDED_LIMIT,
            ...
            if policy.cpu_limit_percent is not None:
                ...
                result = self._kernel32.SetInformationJobObject(
                    ...
                    _JOB_OBJECT_INFO_CLASS_CPU_RATE_CONTROL,
